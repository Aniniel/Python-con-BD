...
-- TABLA PATROCIANDORES

CREATE TABLE PATROCINADORES (
  NOMBRE VARCHAR(50),	
  TOTAL_CARRERAS_PATROCINADAS DOUBLE,
...
CREATE TABLE APUESTAS (
  CODIGO VARCHAR(10),
  IMPORTE_MAXIMO DOUBLE,
  IMPORTE_MINIMO DOUBLE,
  TANTO_A_UNO DOUBLE,
...
CREATE TABLE uso_pistas (
  ...
  numero_de_pista TINYINT NOT NULL,
